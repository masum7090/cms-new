...
<div class="content-wrapper">
    <div class="row">
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-md-8">
                    <h3 class="font">Welcome to College Monitoring System (Admin)</h3>
                    <h4 class="font"><b>National University, Bangladesh</b></h4>
                </div>
                <div class="col-md-4">
                    <!-- <div class="justify-content-end d-flex">
                        <div id="MyClockDisplay" class="clock" onload="showTime()" style="
                            color: #5050B2;
                            font-size: 22px;
                            font-family: Lato;
                            letter-spacing: 7px;">
                ...
                <!-- <div class="col-md-12">
                    <div class="justify-content-end d-flex">
                        <div id="MydateDisplay" class="clock" onload="showdate()" style="
                            margin-top:-45px;
                            color: #5050B2;
                            font-size: 18px;
                            font-family: Lato;
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="carddcdc">
                <div class="card-people mt-auto" style="border-radius:0px;">
                    <img src="{{asset('assets/images/dashboard/nu-office.png')}}" alt="people"
                        style="margin-top: -19px; margin-bottom: 20px; height: 100%; border-radius:5px;">
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-4 stretch-card transparent">
                    <div class="card card-tale">
                        <div class="card-body">
                            <p class="mb-4">Total College</p>
                            <p class="fs-30 mb-2">2850</p>
                            <p>10.00%</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                    <div class="card card-light-blue">
                        <div class="card-body">
                            <p class="mb-4">Number of Studentss</p>
                            <p class="fs-30 mb-2">340040</p>
                            <p>2.00% (30 days)</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 stretch-card transparent">
                    <div class="card card-light-danger">
                        <div class="card-body">
                            <p class="mb-4">Number of Staffs</p>
...
<script>
    ...
    function showdate() {
        ...
        document.getElementById("MydateDisplay").textContent = ("Today is: " + day + "/" + month + "/" + year);
    }
