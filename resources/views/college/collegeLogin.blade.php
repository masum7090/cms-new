                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="card" style="text-align:center;">
                            <div class="text-center py-5 px-4 px-sm-5"
                                ...
                                <form class="pt-3 text-left" method="POST" action="{{url('college/college-login')}}">
                                    @csrf
                                    <label for="email" style="background-color:#fff; margin-left:10px; color:#969696; fony-size:18px;font-weight: bold;"><span>{{ __('User ID') }}</span><span style="color:#C11F1F;"> *</span></label>
                                    <div class="form-group"  style="margin-top:-29px;">
                                        <input id="email" type="email" style="font-size:14px; padding:15px;"
                                            ...
                                            name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="6456@nu.ac.bd"
                                            autofocus>
