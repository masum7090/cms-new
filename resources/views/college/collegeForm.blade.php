    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card" style="border-bottom:none;">
                <span style="padding:10px; font-size:16px; color:#7A7A7A; font-family: 'Lato', sans-serif;"><b>Form List (College wise)</b></span>
            </div>
        </div>
        <div class="col-md-12">
                                                    ...
                                                    <div class="row"
                                                        ...
                                                        <div class="card" style="margin:10px;
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group" style="margin-bottom:0px;">
                                                                        <label class="col-form-label"
                                                                            style="margin-bottom:-5px; float:left;">প্রতিষ্ঠানটির নিকটবর্তী প্রশাসনিক ইউনিট:
                                                                            </label>
                                                                        <input type="text" class="form-control"
                                                                            value="জেলা সদর" name="collBnName" disabled />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="card" style="margin:10px;
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group" style="margin-bottom:0px;">
                                                                        <label class="col-form-label"
                                                                            style="margin-bottom:-5px; float:left;">প্রতিষ্ঠানটির নিকটবর্তী ইউনিটের দূরত্ব:
                                                                            </label>
                                                                        <input type="text" class="form-control"
                                                        ...
                                                        <div class="card" style="margin:10px;
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group" style="margin-bottom:0px;">
                                                                        <label class="col-form-label"
                                                                            style="margin-bottom:-5px; float:left;">নিকটবর্তী অনুরূপ শিক্ষা প্রতিষ্ঠান দূরত্ব:
                                                                            </label>
                                                                        <input type="text" class="form-control"
                                                        ...
                                                        <div class="card" style="margin:10px;
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group" style="margin-bottom:0px;">
                                                                        <label class="col-form-label"
                                                                            style="margin-bottom:-5px; float:left;">প্রতিষ্ঠানটি কোন এলাকায়:
                                                                            </label>
                                                                        <input type="text" class="form-control"
                                                                            value="সিটি কর্পোরেশন" name="collBnName" disabled />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="card" style="margin:10px;
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group" style="margin-bottom:0px;">
                                                                        <label class="col-form-label"
                                                                            style="margin-bottom:-5px; float:left;">জাতীয় বিশ্ববিদ্যালয়ের অধিভুক্ত নিকটবর্তী ন্যূনতম ২ টি প্রতিষ্ঠানের নাম ও ঠিকানা:
                                                                            </label>
                                                                        <input type="text" class="form-control"
                                                                            value="Govt. Bangla College, Mirpur, Dhaka-1216" name="collBnName" disabled />
                                                                        <input type="text" class="form-control"
                                                                        value="BCIC COLLEGE, Mirpur,Dhaka-1216" name="collBnName" disabled />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="card" style="margin:10px;
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group" style="margin-bottom:0px;">
                                                                        <label class="col-form-label"
                                                                            style="margin-bottom:-5px; float:left;">গভর্নিং বডির ধরন
                                                                            </label>
                                                                        <input type="text" class="form-control"
                                                                            value="নিয়মিত" name="collBnName" disabled />
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <div class="form-group" style="margin-bottom:0px;">
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                        <label class="col-form-label"
                                                                            style="margin-bottom:-5px; float:left;">গভর্নিং বডি থাকলে:
                                                                            </label> <br>
                                                                        </div>
                                                                        
                                                                            <div class="col-md-6">
                                                                            <label class="col-form-label"
                                                                            style="margin-bottom:-5px; float:left;">অনুমোদনের তারিখ
                                                                            </label> <br>
                                                                            <input type="text" class="form-control"
                                                                                    value="01/01/2021" name="collBnName" disabled />
                                                                                
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                            <label class="col-form-label"
                                                                            style="margin-bottom:-5px; float:left;">মেয়াদ উত্তীর্ণের তারিখ
                                                                            </label> <br>
                                                                            <input type="text" class="form-control"
                                                                                    value="01/01/2025" name="collBnName" disabled />
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group" style="margin-bottom:0px;">
                                                                        <label class="col-form-label"
                                                                            style="margin-bottom:-5px; float:left;">কমিটিতে মোট সদস্য সংখ্যা
                                                                            </label>
                                                                        <input type="text" class="form-control"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group" style="margin-bottom:0px;">
                                                                        <label class="col-form-label"
                                                                            style="margin-bottom:-5px; float:left;">মহিলা সদস্য সংখ্যা
                                                                            </label>
                                                                        <input type="text" class="form-control"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group" style="margin-bottom:0px;">
                                                                        <label class="col-form-label"
                                                                            style="margin-bottom:-5px; float:left;">বিগত এক বছরে কমিটির অনুষ্ঠিত সভার সংখ্যা:
                                                                            </label>
                                                                        <input type="text" class="form-control"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group" style="margin-bottom:0px;">
                                                                        <label class="col-form-label"
                                                                            style="margin-bottom:-5px; float:left;">কমিটির সদস্যদের নামের তালিকা এবং সভার উপস্থিত তালিকা সংযুক্ত করুন:
                                                                            </label> <br><br>
                                                                        <!-- <button class="btn btn-success" style="margin-left:-166%; margin-top:10px;" type="buttom">Download</button> -->
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group" style="margin-bottom:0px;">
                                                                        <label class="col-form-label"
                                                                            style="margin-bottom:-5px; float:left;">প্রতিষ্ঠাতা সদস্য সংখ্যা কত?
                                                                            </label>
                                                                        <input type="text" class="form-control"
