    ...
    <div class="col-md-12">
            <div class="card">
                <div class="card-body" style="padding:40px;">
                    <h4 class="card-title">Physical Facilities Form</h4>
                    <form class="form-sample">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label class="col-form-label">Organization Name (Bangla)</label>
                                    <div class="col-sm-9">
                            ...
                            <div class="col-md-12">
                            <div class="form-group row">
                                    <label class="col-form-label">Organization Name (English)</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" />
                                    </div>
                                </div>
